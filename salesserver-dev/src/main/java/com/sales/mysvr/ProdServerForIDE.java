...
//		VirtualFile metaFile = new VirtualFileImpl(directory + "/salesserver/src/main/resources/appmetadev.txt");
//		log.info("LOADING from meta file="+metaFile.getCanonicalPath());
	...
	public static VirtualFileImpl modifyForIDE() {
        ...
        if(filePath1.contains("salesserver-dev")) {
            //eclipse starts in salesserver-dev so move one directory back
